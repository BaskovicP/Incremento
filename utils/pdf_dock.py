...
from aqt.qt import (QDockWidget, QWidget, QVBoxLayout, QHBoxLayout,
                    QShortcut, QKeySequence, QTimer, Qt, QDialog, QLabel,
                    QPushButton, QPixmap, qconnect)
from aqt.utils import showInfo, tooltip
from PyQt6.QtWebEngineWidgets import QWebEngineView
from PyQt6.QtWebEngineCore import QWebEnginePage, QWebEngineSettings
from PyQt6.QtCore import QUrl

from .pdf_manager import (PDF_NOTE_TYPE, get_page, get_zoom, get_read_page,
                           set_page, set_zoom, set_read_page)
...
def show_pdf_in_dock(card_id, filename, page, zoom=1.0, via_link=False, read_page=0) -> None:
