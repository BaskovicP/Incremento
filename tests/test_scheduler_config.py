...
class TestReadyFilter:
    def test_all_included(self):
        ...
        assert cfg.ready_filter == (
            "(is:new OR (is:learn is:due) OR (is:review is:due)) -is:suspended"
        )
    ...
    def test_only_learning(self):
        ...
        assert cfg.ready_filter == "(is:learn is:due) -is:suspended"

    def test_only_due(self):
        cfg = SchedulerConfig(include_new=False, include_learning=False, include_due=True)
        assert cfg.ready_filter == "(is:review is:due) -is:suspended"
